...
class cyclic_reduction_solver_t : public locally_onedimensional_solver,
								public base_solver<real_t, cyclic_reduction_solver_t<real_t, aligned_x>>
{
protected:
