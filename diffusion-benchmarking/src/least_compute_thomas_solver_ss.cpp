...
void least_compute_thomas_solver_ss<real_t>::precompute_values(std::unique_ptr<real_t[]>& b,
...
template <typename real_t>
void least_compute_thomas_solver_ss<real_t>::initialize()
{
...
template <typename real_t>
auto least_compute_thomas_solver_ss<real_t>::get_diagonal_layout(const problem_t<index_t, real_t>& problem, index_t n)
{
...
template <typename real_t>
void least_compute_thomas_solver_ss<real_t>::solve_x()
{
	if (this->problem_.dims == 1)
	{
#pragma omp parallel
...
template <typename real_t>
void least_compute_thomas_solver_ss<real_t>::solve_y()
{
	if (this->problem_.dims == 2)
	{
#pragma omp parallel
...
template <typename real_t>
void least_compute_thomas_solver_ss<real_t>::solve_z()
{
#pragma omp parallel
...
template <typename real_t>
void least_compute_thomas_solver_ss<real_t>::solve()
{
	if (this->problem_.dims == 1)
	{
#pragma omp parallel
		{
			perf_counter counter("lstcs");
...
template class least_compute_thomas_solver_ss<float>;
template class least_compute_thomas_solver_ss<double>;
