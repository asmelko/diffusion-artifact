...
- Optimized for temporal locality instead of the spacial one
*/

template <typename real_t>
class least_compute_thomas_solver_ss : public locally_onedimensional_solver,
									   public base_solver<real_t, least_compute_thomas_solver_ss<real_t>>
{
