...
- Substrate dimension is multiplied to be least common multiple of vector register size (tunable by
'vector_register_size') for better vectorization in y/z dimensions
*/
