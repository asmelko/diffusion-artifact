...
{
  data <- read.csv("../results/temporals.csv", header = TRUE, sep = ",")
  data2 <- read.csv("../results/baselines.csv", header = TRUE, sep = ",")
  data3 <- read.csv("../results/biofvms.csv", header = TRUE, sep = ",")
...
{
  data <- read.csv("../results/transpose-temporal.csv", header = TRUE, sep = ",")
  data2 <- read.csv("../results/temporals.csv", header = TRUE, sep = ",")
  data3 <- read.csv("../results/partial-blocking.csv", header = TRUE, sep = ",")
...
{
  data <- read.csv("../results/full-blocking-alt-dist.csv", header = TRUE, sep = ",")
